...
if (!function_exists('baseTheme')) :
    ...
    * to change 'okyesplease' to the name of your theme in all the template files.
    */
    ...
    */
        ...
        register_nav_menus(array(
            'menu-1' => esc_html__('Header', 'okyesplease'),
            'menu-2' => esc_html__('Footer', 'okyesplease'),
        ));
...
function okyesplease_get_social_icons()
{
