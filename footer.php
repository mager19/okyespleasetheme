...
<footer class="site-footer bg-[#345C72]">
    <div class="container mx-auto pt-14 pb-8">
        <div class="site__footer__content flex flex-wrap lg:px-4 justify-center lg:justify-start">
            <div class="content w-full flex flex-wrap items-end">
                <div class="site__footer__logo w-full md:w-8/12 mx-auto lg:w-6/12 text-center lg:text-left mb-0">
                ...
                <div class="site-footer__bottom w-full lg:w-6/12 flex justify-center lg:justify-end px-2">
                    <div class="newsletter newsletter__footer">
                        <label class="labelFooter font-inter pt-4 text-[14px] md:text-[18px] text-white mb-0 flex justify-center md:justify-end">
